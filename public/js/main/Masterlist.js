    ...
    $.ajax({
        ...
        success: function(response){
            ...
            if(masterlistData.length > 0){
                if(masterlistData[0].masterlist_employee_type == 1){
                    $("#selectEmployeeType").val(masterlistData[0].masterlist_employee_type).trigger('change');
                    setTimeout(() => {
                    ...
                    console.log('data ', masterlistData[0].systemone_hris_id);
                }else{
                    $("#selectEmployeeType").val(masterlistData[0].masterlist_employee_type).trigger('change');
                    setTimeout(() => {
                    ...
                    $("input[name='masterlist_id']", $('#formAddMasterlist')).val(masterlistData[0].id);
                    console.log('data ', masterlistData[0].systemone_subcon_id);
                }
